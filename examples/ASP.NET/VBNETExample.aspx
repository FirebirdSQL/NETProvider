...
<script runat="server">
    ...
    Sub Connect()
        ...
        myConnectionString = "Database=EMPLOYEE.FDB;User=SYSDBA;Password=masterkey;Dialect=3;Server=localhost;Pooling=False"
...
<body>
    <center>
        <form id="myform" runat="server">
            <asp:DropDownList id="cboSelectEmployee" runat="server" DataTextField="First_Name" DataValueField="Emp_No" BackColor="Azure"></asp:DropDownList>
            <p>
                <asp:Button id="cmdNew" onmouseover="this.style.backgroundColor='lightblue';this.style.fontWeight='b&#13;&#10;&#9;&#9;old'" onclick="GetNew" onmouseout="this.style.backgroundColor='buttonface';this.style.fontWeight='n&#13;&#10;&#9;&#9;ormal'" runat="server" Text="New Search" Height="25px" ForeColor="Black" Font-Size="X-Small" Font-Names="Arial" Width="100px"></asp:Button>
                &nbsp; 
                <asp:Button id="cmdSaved" onmouseover="this.style.backgroundColor='gold';this.style.fontWeight='bold'" onclick="UseSaved" onmouseout="this.style.backgroundColor='buttonface';this.style.fontWeight='n&#13;&#10;&#9;&#9;ormal'" runat="server" Text="Use Current" Height="25px" ForeColor="Black" Font-Size="X-Small" Font-Names="Arial" Width="100px"></asp:Button>
            </p>
            <p>
            ...
            <div id="Layer1" title="Salary History" style="OVERFLOW: scroll; WIDTH: 980px; POSITION: relative; HEIGHT: 300px">
                <asp:datagrid id="mydatagrid" runat="server" BackColor="White" Font-Size="X-Small" Font-Names="Verdana" OnItemDataBound="MyDataGrid_ItemDataBound" OnUpdateCommand="MyDataGrid_Update" OnCancelCommand="MyDataGrid_Cancel" OnDeleteCommand="MyDataGrid_Delete" OnEditCommand="MyDataGrid_Edit" OnItemCreated="MyDataGrid_ItemCreated" GridLines="Vertical" CellPadding="3" BorderColor="#999999" BorderWidth="1px" BorderStyle="None" AutoGenerateColumns="False">
