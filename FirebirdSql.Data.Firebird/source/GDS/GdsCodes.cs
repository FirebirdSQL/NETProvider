...
namespace FirebirdSql.Data.Firebird.Gds
{
	internal class GdsCodes
	{
		...
		#region DATABASE_PARAMETER_BLOCK_STUFF
		...
		#region TRANSACTION_PARAMETER_BLOCK_STUFF
		...
		#region SERVICE_PARAMETER_BLOCK
		...
		#region SERVICE_INFORMATION_ITEMS
		...
		#region SVC_PROPERTIES_PARAMETERS
		...
		#region BACKUP_SERVICE_PARAMETERS
		...
		#region RESTORE_SERVICE_PARAMETERS
		...
		#region SECURITY_SERVICE_PARAMETERS
		...
		#region LICENSING_SERVICE_PARAMETERS
		...
		#region COMMON_STRUCTURAL_CODES
		...
		#region DATABASE_INFORMATION_ITEMS
		...
		#region SQL_INFORMATION_RETURN_VALUES
		...
		#region REQUEST_INFORMATION_ITEMS
		...
		#region ARRAY_SLICE_DESCRIPTION_LANGUAGE
		...
		#region ISC_ERROR_CODES

		public const int	SUCCESS			= 0;
		public const int	GENERIC_SQLCODE = -999;
		...
		public const uint	CLASS_MASK	= 0xF0000000;	// Defines the code as warning, error, info, or other
		...
		/// <summary>
		/// The constant array <b>FATAL_ERRORS</b> holds an ORDERED
		/// longer usable.  This is used in the .net provider to determine
		...
		/// </summary>
		public static int[] FATAL_ERRORS = new int[] {
														 ...
														 isc_bufinuse			,
														 isc_bdbincon			,
														 // isc_reqinuse, User level error, not fatal.
														 isc_badodsver			,
														 isc_dirtypage			,
														 isc_doubleloc			,
														 isc_nodnotfnd			,
