...
{
	internal class CommandTextEditor : System.Windows.Forms.Form
	{
		...
		private CommandTextEditor()
		{
			InitializeComponent();
		}

		public CommandTextEditor(FbCommand command) : this()
		{
		...
		private void InitializeComponent()
		{
			...
			// tabCommon
			// 
			this.tabCommon.Controls.AddRange(new System.Windows.Forms.Control[] {
																					this.tabResult,
																					this.tabPlan,
																					this.tabError});
			...
			// tabResult
			// 
			this.tabResult.Controls.AddRange(new System.Windows.Forms.Control[] {
																					this.grdResult});
			...
			// tabPlan
			// 
			this.tabPlan.Controls.AddRange(new System.Windows.Forms.Control[] {
																				  this.txtPlan});
			...
			// tabError
			// 
			this.tabError.Controls.AddRange(new System.Windows.Forms.Control[] {
																				   this.txtError});
