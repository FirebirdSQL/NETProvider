...
{
	internal class FbProcedurePrivilegesSchema : FbAbstractDbSchema
	{
		#region CONSTRUCTORS

		public FbProcedurePrivilegesSchema() : base("Procedure_Privileges")
		{
		}
		...
		{
			AddRestrictionColumn("rdb$relation_name", "PROCEDURE_NAME"	, null);
		...
		{
			AddWhereFilter("rdb$object_type = 5");
		}
