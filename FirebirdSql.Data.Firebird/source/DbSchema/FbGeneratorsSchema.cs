...
{
	internal class FbGeneratorsSchema : FbAbstractDbSchema
	{
		#region CONSTRUCTORS

		public FbGeneratorsSchema() : base("Generators")
		{
		}
		...
		{
			AddTable("rdb$generators");
		}

		public override void AddRestrictionColumns()
		{
			AddRestrictionColumn("rdb$generator_name", "GENERATOR_NAME", null);
			AddRestrictionColumn("rdb$system_flag", "SYSTEM_GENERATOR", null);
		}

		public override void AddDataColumns()
		{
			AddDataColumn("rdb$generator_id", "GENERATOR_ID");
		}
