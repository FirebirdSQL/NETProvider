...
namespace FirebirdSql.Data.Firebird.DbSchema
{
	internal class FbTablesSchema : FbAbstractDbSchema
	{
		...
		{
			AddTable("rdb$relations");
		}

		public override void AddRestrictionColumns()
		{
			AddRestrictionColumn("rdb$relation_name", "TABLE_NAME", null);
			AddRestrictionColumn("rdb$view_blr"		, "TABLE_TYPE", null);
			AddRestrictionColumn("rdb$system_flag"	, "SYSTEM_TABLE", null);
		}
		...
		{
			AddOrderBy("rdb$system_flag");
			AddOrderBy("rdb$owner_name");
