...
namespace FirebirdSql.Data.Firebird.Design
{
	...
	internal class FbDataAdapterConfigurationStep7 : ActionStep
	{
		...
		private void InitializeComponent()
		{
			...
			this.lblMessage1.Size = new System.Drawing.Size(151, 15);
			...
			this.lblMessage2.Size = new System.Drawing.Size(264, 15);
			...
			this.lblMessage3.Size = new System.Drawing.Size(138, 15);
			...
			this.lblFinish.Size = new System.Drawing.Size(289, 15);
			...
			this.lblMessage.Size = new System.Drawing.Size(243, 15);
		...
		private void GenerateDmlStatements(FbDataAdapter adapter)
		{
			...
			try
			{
				...
				// Insert command
				adapter.InsertCommand.CommandText	= insert.CommandText;
				adapter.InsertCommand.Connection	= connection;
				adapter.InsertCommand.CommandType	= CommandType.Text;
				this.CopyParameters(insert, adapter.InsertCommand);

				// Update command
				adapter.UpdateCommand.CommandText	= update.CommandText;
				adapter.UpdateCommand.Connection	= connection;
				adapter.UpdateCommand.CommandType	= CommandType.Text;
				this.CopyParameters(update, adapter.UpdateCommand);

				// Delete command
				adapter.DeleteCommand.CommandText	= delete.CommandText;
				adapter.DeleteCommand.Connection	= connection;
