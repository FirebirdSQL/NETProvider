...
namespace FirebirdSql.Data.Gds
{
	internal class XdrStream : Stream, IDisposable
	{
		...
		{
			return this.ReadString(this.charset.Encoding);
		}

		public string ReadString(int length)
		{		
			return this.ReadString(this.charset.Encoding, length);
		}
		...
		{	        				        
			this.WriteBuffer(
				this.charset.Encoding.GetBytes(value), 
				this.charset.Encoding.GetByteCount(value));
		}
