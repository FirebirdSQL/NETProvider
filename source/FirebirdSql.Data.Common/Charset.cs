...
namespace FirebirdSql.Data.Common
{
	internal sealed class Charset
	{
        ...
        private readonly static ArrayList supportedCharsets = Charset.InitializeSupportedCharsets();
        ...
        {
            get { return (Charset)Charset.supportedCharsets[0]; }
        }
        ...
        private static ArrayList InitializeSupportedCharsets()
        {
