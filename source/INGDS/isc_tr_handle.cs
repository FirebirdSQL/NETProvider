...
{
	/// <include file='xmldoc/isc_tr_handle.xml' path='doc/member[@name="T:TxnState"]/*'/>
	...
	{	
		/// <include file='xmldoc/isc_tr_handle.xml' path='doc/member[@name="P:DbHandle"]/*'/>
		...
		/// <include file='xmldoc/isc_tr_handle.xml' path='doc/member[@name="P:State"]/*'/>
		TxnState State
		{
			get;
		}
