...
namespace FirebirdSql.Data.FirebirdClient
{
...
#if	(NET)
	[ListBindable(false)]
	[Editor(typeof(FirebirdSql.Data.Design.Parameters.FbParameterCollectionEditor), typeof(System.Drawing.Design.UITypeEditor))]
#endif
	public sealed class FbParameterCollection : DbParameterCollection
	{
		...
		{
			this.parameters.CopyTo((FbParameter[])array, index);
		}
