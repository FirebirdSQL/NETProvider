...
namespace FirebirdSql.Data.FirebirdClient
{
	...
	[ToolboxItem(true)]
	[System.Drawing.ToolboxBitmap(typeof(FbConnection), "Resources.FbConnection.bmp")]
#endif
	public sealed class FbConnection : DbConnection, ICloneable
	{
		...
		public static void CreateDatabase(string connectionString, int pageSize, bool forcedWrites, bool overwrite)
		{
			...
			try
			{
				...
				if (options.Charset.Length > 0)
				{
					...
					{
						dpb.Append(IscCodes.isc_dpb_set_db_charset, Charset.SupportedCharsets[index].Name);
					}
				}
                ...
                if (!overwrite)
                {
                    dpb.Append(IscCodes.isc_dpb_overwrite, 0);
                }
                else 
                {
                    dpb.Append(IscCodes.isc_dpb_overwrite, 1);
                }                
		...
		[DefaultValue("")]
		[Editor(typeof(FirebirdSql.Data.Design.Connection.FbConnectionStringUIEditor), typeof(System.Drawing.Design.UITypeEditor))]
#endif
