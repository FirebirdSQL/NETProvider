	...
	public class BaseTest
	{
		...
		public virtual void SetUp()
		{
			...
			connectionString.AppendFormat(
				"User={0};Password={1};Database={2};DataSource={3};Port={4};Charset={5};Pooling={6};ServerType={7}",
			...
			BaseTest.createTables(connectionString.ToString());
			BaseTest.insertTestData(connectionString.ToString());
			BaseTest.createProcedures(connectionString.ToString());
			BaseTest.createTriggers(connectionString.ToString());
						
			this.connection = new FbConnection(connectionString.ToString());
		...
		private static void createDatabase()
		{
			...
			values.Add("Charset"	, 
				ConfigurationSettings.AppSettings["Charset"]);
			values.Add("ServerType"	, 
				Convert.ToInt32(ConfigurationSettings.AppSettings["ServerType"]));
