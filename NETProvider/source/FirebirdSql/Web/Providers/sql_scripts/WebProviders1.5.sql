...
CREATE TABLE USERS (
    ...
    UPPERUSERNAME               VARCHAR(252) CHARACTER SET NONE,
    APPLICATIONNAME             VARCHAR(252) CHARACTER SET NONE NOT NULL,
    EMAIL                       VARCHAR(128) CHARACTER SET NONE NOT NULL,
    UPPEREMAIL                  VARCHAR(128) CHARACTER SET NONE,
...
CREATE PROCEDURE MEMBERSHIP_CREATEUSER (
    ...
    EMAIL VARCHAR(128) CHARACTER SET NONE,
    PASSWORDQUESTION VARCHAR(255) CHARACTER SET UNICODE_FSS,
    PASSWORDANSWER VARCHAR(255) CHARACTER SET UNICODE_FSS,
    ISAPPROVED SMALLINT,
...
DECLARE VARIABLE VNAME VARCHAR(252) CHARACTER SET NONE;
BEGIN
...
CREATE PROCEDURE MEMBERSHIP_FINDUSERSBYEMAIL (
    APPLICATIONNAME VARCHAR(252) CHARACTER SET NONE,
    EMAILTOMATCH VARCHAR(128) CHARACTER SET NONE,
    PAGEINDEX INTEGER,
    PAGESIZE INTEGER)
RETURNS (
    USERNAME VARCHAR(252) CHARACTER SET NONE,
