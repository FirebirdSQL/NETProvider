...
namespace FirebirdSql.Data.Bdp
{
	public class FbMetaData : ISQLMetaData
	{
		...
		public ISQLExtendedMetaData GetExtendedMetaData()
		{
#warning "GetExtendedMetaData is not supported yet"
        	return null;        // For now, extended meta data is not supported
		}
