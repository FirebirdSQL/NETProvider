...
namespace FirebirdSql.Data.Bdp.UnitTests
{
	...
	{	
		...
		public void ExecuteScalarTest()
		{
			...
			Assert.AreEqual(charFieldValue, "IRow 2", "Wrong value.");
			command.Close();
		}
...
//			string sql = "update test set char_field = 'carlos@firebird.org', bigint_field = @bigint, varchar_field = 'carlos@ado.net' where int_field = @integer";
			string sql = "update test set char_field = 'carlos@firebird.org', bigint_field = ?, varchar_field = 'carlos@ado.net' where int_field = ?";
